...
$('#element_2').change(function(){
  switch($("#element_2 :selected").text()) {
    ...
    case "Irene Perazza": $("#element_3").val('iperazza@ceibal.edu.uy'); break;
...
function actualizarFechas() {
  ...
  console.log('Total horas viaje:', totalHorasViaje); // <-- Agrega esto
...
function determinarViajes(x) {
  ...
  else { return "Sin viaje (0 horas)"; } // <-- Agrega esto
}
